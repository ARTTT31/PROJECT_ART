...
export default function NotificationBell() {
  ...
  return (
    <div className="relative" ref={panelRef}>
      ...
      {open && (
        <div className="absolute right-0 z-[var(--z-dropdown)] mt-2 w-[min(calc(100vw-2rem),28rem)] overflow-hidden rounded-[var(--art-radius-lg)] border border-white/50 bg-white/95 shadow-glass-lg">
          {/* Panel header */}
          <div className="flex items-start justify-between gap-4 border-b border-slate-100 px-5 py-4">
            ...
            <div className="flex shrink-0 items-center gap-2">
              {notifications.length > 0 && (
                <button
                  onClick={markAllRead}
                  className="art-soft-button !min-h-10 !gap-1.5 !px-3 !py-2 !text-xs"
                >
          ...
          <div className="max-h-[26rem] overflow-y-auto p-3">
            {notifications.length === 0 ? (
              <div className="flex flex-col items-center justify-center rounded-[var(--art-radius-lg)] border border-dashed border-slate-200 bg-slate-50/70 px-6 py-10 text-center text-slate-500">
              ...
              >
                ...
                <button
                  ...
                  className="art-icon-button small-control absolute right-2 top-8 !h-8 !w-8 !rounded-lg !border-transparent !bg-white/40 !shadow-none"
